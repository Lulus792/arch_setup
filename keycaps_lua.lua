...
map("n", "<leader>tw", ":Trouble workspaces_diagnostics<CR>", opts)
map("n", "<leader>td", ":Trouble document_diagnostics<CR>", opts)
map("n", "<leader>tr", ":Trouble lsp_references<CR>", opts)
map("n", "<leader>tq", ":Trouble quickfix<CR>", opts)
...
map("n", "<leader>gt", ":GlobalNoteToggle<CR>", opts)       -- Toggle note
map("n", "<leader>gc", ":GlobalNoteClear<CR>", opts)        -- Clear note

---------------------------------------------------------------------
-- QUALITY OF LIFE
---------------------------------------------------------------------
map("n", "<leader>sv", ":source $MYVIMRC<CR>", opts)         -- Reload config
